...
ActiveRecord::Schema.define(version: 6) do
  ...
  create_table "recipes_ingredients_usages", force: :cascade do |t|
    t.integer "recipe_id"
    t.integer "ingredient_id"
    t.string "quantity"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ingredient_id"], name: "index_recipes_ingredients_usages_on_ingredient_id"
    t.index ["recipe_id"], name: "index_recipes_ingredients_usages_on_recipe_id"
  end
